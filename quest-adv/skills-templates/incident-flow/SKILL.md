...
<!-- [빈칸] 미션 카드의 단계표를 보고 스킬 이름과 산출물 경로를 채우세요 -->
1. 수집 → (채우기: 스킬 이름) 스킬 → output/(채우기)
2. 분석 → (채우기: 스킬 이름) 스킬 → output/(채우기)
3. 초안 → (채우기: 스킬 이름) 스킬 → output/(채우기)
4. 검증 → (채우기: 스킬 이름) 스킬 → output/(채우기)
